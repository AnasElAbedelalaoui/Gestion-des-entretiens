						...
						<h1>Mon Planning</h1>
							<?php
								...
								$sql_request = "SELECT e.idEn, e.typee, e.idsal, h.dates, h.horraire 
												...
												where e.idEn in (select idEn from Surveillance);";
								...
								for ($index = 0; $index < count($analyzing_result); $index++){
									...
									echo "<div id='entretien_dispo' style='background-color: green; margin: 10px; width:120px;'>
											Type: ".$analyzing_result[$index]["typee"]."<br>Salle: ".$analyzing_result[$index]["idsal"]."<br>Date: ".$analyzing_result[$index]["dates"]."<br>Heure de debut: ".$analyzing_result[$index]["horraire"]."</div>";
								};
