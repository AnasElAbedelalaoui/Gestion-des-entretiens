...
<html> 
	<head>
		...
		<title>Entretien de recrutements</title>
	</head>
<?php   
 ...
 ?>
	<body>
		...
		<div id = "corps">
				...
				<div id="information">
					<h1>Entretien de recrutements</h1>
					<p>La notation se fera en 3 niveaux pour chacune des 3 phases "présentation", "échange" et "Motivations".<br>
						
						Pour chacune des 3 phases (en s'appuyant sur les attentes du guide): 
						<ul>
					...
					<select name='butselect'>
						<?php
							$sql = "select e.idEtu, e.nomEtu, e.prenomEtu, e.emailEtu, p.idEn
									...
									where (select typee from Entretien where idEn like p.idEn) like 'PEIP' and (select idEns from Surveillance where idEn like p.idEn) like ".$GLOBALS["_COOKIE"]["idEns"].";";
