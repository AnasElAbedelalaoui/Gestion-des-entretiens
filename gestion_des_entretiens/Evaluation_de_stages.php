...
<html> 
	<head>
		...
		<title>Evaluation de stages </title>
	</head>
<?php   
	...
	<body>
		...
		<div id = "corps">
				...
				<div id="information">
					...
					<select name='butselect'>
						<?php
							$sql = "select e.idEtu, e.nomEtu, e.prenomEtu, e.emailEtu, p.idEn
									...
									where (select typee from Entretien where idEn like p.idEn) like 'stage' and (select idEns from Surveillance where idEn like p.idEn) like ".$GLOBALS["_COOKIE"]["idEns"].";";
					...
					<table>
						<tr>
							<th>Evaluation à l'aide d'une croix par ligne sur l'echelle proposée</th>
							<th>Très Bien<br>18</th>
							<th>Bien<br>14</th>
							<th>Moyen<br>10</th>
							<th>Insuffisant<br>6</th>
						</tr>
						<tr>
							<td><strong>Presentation: </strong>Utilisation des éléments non verbaux de l'expression (gestes, dynamique) en vue d'une communication efficace.</td>
						...
						<tr>
							<td><strong>Support: </strong> Pertinence et efficacité des choix de support de presentation.</td>
							<td><input type="checkbox" name="Insuffisant"></td>
							<td><input type="checkbox" name="Moyen"></td>
							<td><input type="checkbox" name="B"></td>
							<td><input type="checkbox" name="TB"></td>
						...
						<tr>
							<td><strong>Maitrise du temps de parole</strong> (20min)</td>
							<td><input type="checkbox" name="Insuffisant"></td>
							<td><input type="checkbox" name="Moyen"></td>
							<td><input type="checkbox" name="B"></td>
							<td><input type="checkbox" name="TB"></td>
						...
						<tr>
							<td><strong>Expression orale: </strong> Maitrise des éléments oraux de l'expression (articulation, débit, rythme, puissance de la voix).</td>
							<td><input type="checkbox" name="Insuffisant"></td>
							<td><input type="checkbox" name="Moyen"></td>
							<td><input type="checkbox" name="B"></td>
							<td><input type="checkbox" name="TB"></td>
						...
						<tr>
							<td><strong>Esprit de synthèse:</strong> hiérarchisation de la présentation, enchainement logique des informations et des idées</td>
							<td><input type="checkbox" name="Insuffisant"></td>
							<td><input type="checkbox" name="Moyen"></td>
							<td><input type="checkbox" name="B"></td>
							<td><input type="checkbox" name="TB"></td>
						...
						<tr>
							<td><strong>Mise en valeur du travail effectué</strong></td>
							<td><input type="checkbox" name="Insuffisant"></td>
							<td><input type="checkbox" name="Moyen"></td>
							<td><input type="checkbox" name="B"></td>
							<td><input type="checkbox" name="TB"></td>
						...
						<tr>
							<td><strong>Apport personnel: </strong> Pertinen des commentaires personnels (points de vue, jugements, enseignements tirés)</td>
							<td><input type="checkbox" name="Insuffisant"></td>
							<td><input type="checkbox" name="Moyen"></td>
							<td><input type="checkbox" name="B"></td>
							<td><input type="checkbox" name="TB"></td>
						...
						<tr>
							<td><strong>Maitrise du sujet</strong>, réponse aux questions</td>
							<td><input type="checkbox" name="Insuffisant"></td>
							<td><input type="checkbox" name="Moyen"></td>
							<td><input type="checkbox" name="B"></td>
							<td><input type="checkbox" name="TB"></td>
