	...
	<body>
		<div id="box">
			<div id = "en_tete">
				<ul id="element">
					<li>
						<a href="Enseignant.php" class="logo"><b Style="color:white;font-size:25px;">POLYTECH <span Style="color:#33FFBC;">ANNECY</span></b></a>
					</li>
					<li>
		...
		<div id = "corps">
				...
				<div id="information">
					<div id="dispo">
						...
						<h3>Crénau horaire: </h3>
							<?php
								$idEns = $GLOBALS["_COOKIE"]["idEns"];
								echo "<div style='display:flex; flex-wrap: wrap;margin-left: 80px;'>";
								$sql_request = "SELECT e.idEn, e.typee, e.idsal, h.dates, h.horraire 
												from Entretien e 
												join Horraire h on e.idH = h.idH 
												where e.idEn not in (select idEn from Surveillance where idEns like ".$idEns.");";
								...
								echo "<input type='hidden' name='id_enseignant' value =".$idEns.">";
								
								for ($index = 0; $index < count($analyzing_result); $index++){
									$idEn = $analyzing_result[$index]["idEn"];
									echo "<Button name='val' value =".$idEn." type='submit' style='width:175px;margin: 10px;'><div id='entretien_dispo' style='margin: 10px; width:120px;'>
											Type: ".$analyzing_result[$index]["typee"]."<br>Salle: ".$analyzing_result[$index]["idsal"]."<br>Date: ".$analyzing_result[$index]["dates"]."<br>Heure de debut: ".$analyzing_result[$index]["horraire"]."</div></Button>";
								};
